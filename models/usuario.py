...
class Usuario(Base):
    ...
    created_at = mapped_column("created_at_usuario", DateTime, default=datetime.utcnow)
    updated_at = mapped_column("updated_at_usuario", DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
